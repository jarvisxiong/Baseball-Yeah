...
/**
 * @ClassName: PickupAddressInfo
 * @Description: 代取件取件地址实体
 * @author: xulang
 * @Date: 2016-08-09 13:36
 */
public class PickupAddressInfo implements Serializable {
    private static final long serialVersionUID = 4901348282539360160L;
    /**
     * 主键
     */
