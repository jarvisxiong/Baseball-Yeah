...
import com.rofour.baseball.common.CustomJsonDateSerializer;

import java.util.Date;

public class MsgTmplSmsInfo {
    private Integer id;
    ...
    public MsgTmplSmsInfo(Integer id, Integer tmplCode, String tmplName, String tmplContent, String placeSign, Date createTime, Date updateTime, Byte state, Integer msgType, String msgTypeName) {
        this.id = id;
