...
/**
 *
 * @ClassName: ReportStoreSmsInfo
 * @Description: 货源短信统日报表
 * @author xl
 * @date 2016年4月21日 上午11:30:03
 *
 */
public class ReportStoreSmsInfo implements Serializable {

	private static final long serialVersionUID = 8448325967610044624L;
	/**
	 * 门店Id
	 */
	private long siteId;
	...
	public String toString() {
		return "ReportStoreSmsInfo [siteId=" + siteId + ", siteCode=" + siteCode + ", siteName=" + siteName
