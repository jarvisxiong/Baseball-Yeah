...
public class ReportThirdPartyInfo implements Serializable {
    ...
    public ReportThirdPartyInfo() {
        super();
    }

    public ReportThirdPartyInfo(Long reportId, Date reportDate, Long collegeId, String collegeName, Long areaId, String areaName, String businessPrincipal, Long totalPhoneNum, Long totalRegNum, Long totalUnregNum, BigDecimal regRate, Long newNum) {
