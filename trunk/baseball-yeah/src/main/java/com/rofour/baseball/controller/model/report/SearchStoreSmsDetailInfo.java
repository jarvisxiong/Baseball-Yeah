...
/**
 * @ClassName: SearchStoreSmsDetailInfo
...
public class SearchStoreSmsDetailInfo implements Serializable {
	...
	public String toString() {
		return "SearchStoreSmsDetailInfo [storeName=" + storeName + ", billNo=" + billNo + ", phone=" + phone
