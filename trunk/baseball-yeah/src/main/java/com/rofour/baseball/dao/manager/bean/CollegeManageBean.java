...
/**
 * 
 * @ClassName: CollegeManageBean
 * @Description: 学校管理实体类
 * @author xl
 * @date 2016年4月7日 下午7:15:00
 *
 */
public class CollegeManageBean implements Serializable {

	private static final long serialVersionUID = 3010415187828618606L;
	/**
	 * 编码
	 */
