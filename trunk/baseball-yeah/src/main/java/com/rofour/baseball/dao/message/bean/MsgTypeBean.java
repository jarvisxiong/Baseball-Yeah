...
public class MsgTypeBean implements Serializable {
    ...
    public MsgTypeBean(Integer id, Integer msgType, String msgTypeName, Date sendStartTime, Date sendEndTime, Byte state) {
        this.id = id;
    ...
    public MsgTypeBean(Integer id, Integer msgType, String msgTypeName, Date sendStartTime, Date sendEndTime, Byte state, String typeTitle, Byte typeLevel, Integer parentType, Byte receiveRole, String headUrl) {
        this.id = id;
        this.msgType = msgType;
        this.msgTypeName = msgTypeName;
        this.sendStartTime = sendStartTime;
