 ...
 */
public class ReportThirdPartyInfoBean  implements Serializable {

    private static final long serialVersionUID = 7976942061062633759L;
    /**
     * 编号
     **/
    ...
    public ReportThirdPartyInfoBean() {
        super();
    }

    public ReportThirdPartyInfoBean(Long reportId, Date reportDate, Long collegeId, String collegeName, Long areaId, String areaName, String businessPrincipal, Long totalPhoneNum, Long totalRegNum, Long totalUnregNum, BigDecimal regRate, Long newNum) {
