...
/**
 * @ClassName: UserDrawCheckBean
 * @Description: 用户提现审核实体
 * @author xl
 * @date 2016年5月30日 下午4:29:26
 */
public class UserDrawCheckBean implements Serializable {

	private static final long serialVersionUID = -4025603735478786211L;
	/**
	 * 账户兑换ID
	 */
