...
import com.rofour.baseball.dao.manager.mapper.SmsVendorMapper;
...
public class SmsVendorServiceImpl implements SmsVendorService {
	 ...
	 * @param smsVendorId
	 * @return
	 * @see com.rofour.baseball.idl.managecenter.service.SmsVendorService#deleteByPrimaryKey(java.lang.String)
	 */
	@Override
	 ...
	 * @param record
	 * @return
	 * @see com.rofour.baseball.idl.managecenter.service.SmsVendorService#insert(com.rofour.baseball.idl.managecenter.service.entity.SmsVendorInfo)
	 */
	@Override
	 ...
	 * @param smsVendorId
	 * @return
	 * @see com.rofour.baseball.idl.managecenter.service.SmsVendorService#selectByPrimaryKey(java.lang.String)
	 */
	@Override
	 ...
	 * @param record
	 * @return
	 * @see com.rofour.baseball.idl.managecenter.service.SmsVendorService#updateByPrimaryKey(com.rofour.baseball.idl.managecenter.service.entity.SmsVendorInfo)
	 */
	@Override
	 ...
	 * @return
	 * @see com.rofour.baseball.idl.managecenter.service.SmsVendorService#selectAll()
	 */
	@Override
	 ...
	 * @param info
	 * @return 
	 * @see com.rofour.baseball.service.manager.SmsVendorService#getTotal(com.rofour.baseball.controller.model.manager.SmsVendorInfo)
	 */
	@Override
	...
	private void validateInfo(SmsVendorInfo smsVendor) {
		...
		if (smsVendor.getSmsVendorCode().length() > 20 || smsVendor.getSmsVendorName().length() > 100
				...
				|| smsVendor.getInterfaceAddress().length() > 500) {
	...
	public void delCache() {
		String redisMapKey = RedisKeyConstants.SMS_VENDOR_MAP;
		redisCommons.delete(redisMapKey);
		String redisListKey = RedisKeyConstants.SMS_VENDOR_LIST;
		redisCommons.delete(redisListKey);
	}
