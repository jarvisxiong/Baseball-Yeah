...
import com.rofour.baseball.dao.store.mapper.BusinessChannelMapper;
import com.rofour.baseball.service.store.BusinessChlService;
...
public class BusinessChlServiceImpl implements BusinessChlService {
     ...
     * @return 
     * @see com.rofour.baseball.service.store.BusinessChlService#selectAllBusinessChl(com.rofour.baseball.controller.model.store.BusinessChannelInfo)
     */
    @Override
	 ...
	 * @param businessChannelInfo
	 * @return 
	 * @see com.rofour.baseball.service.store.BusinessChlService#selectAllBusinessChlTotal(com.rofour.baseball.controller.model.store.BusinessChannelInfo)
	 */
	@Override
     ...
     * @param channelId
     * @return 
     * @see com.rofour.baseball.service.store.BusinessChlService#delBussinessChl(java.lang.Long)
     */
    @Override
     ...
     * @param channelId
     * @return 
     * @see com.rofour.baseball.service.store.BusinessChlService#cancleBussinessChl(java.lang.Long)
     */
    @Override
     ...
     * @param channelId
     * @return 
     * @see com.rofour.baseball.service.store.BusinessChlService#enabledBussinessChl(java.lang.Long)
     */
    @Override
     ...
     * @param businessChannelInfo
     * @return 
     * @see com.rofour.baseball.service.store.BusinessChlService#addBussinessChl(com.rofour.baseball.controller.model.store.BusinessChannelInfo)
     */
    @Override
     ...
     * @param channelCode
     * @return 
     * @see com.rofour.baseball.service.store.BusinessChlService#ifExistChannelCode(java.lang.String)
     */
    @Override
