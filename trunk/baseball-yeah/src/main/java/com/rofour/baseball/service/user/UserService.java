...
import com.rofour.baseball.controller.model.user.AddresseeInfo;
...
import com.rofour.baseball.dao.user.bean.UserOfPotentialBean;
...
public interface UserService {
	 ...
	 * @return
     */
	ResultInfo<Object> updatePuserStatus(Map<String,String> map);
}
