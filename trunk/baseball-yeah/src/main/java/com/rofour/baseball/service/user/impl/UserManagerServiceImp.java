...
import com.rofour.baseball.controller.model.user.ExpUserAuditResultInfo;
import com.rofour.baseball.controller.model.user.ExpUserPerfectInfo;
...
import com.rofour.baseball.dao.user.mapper.UserTypeMapper;
    ...
    public int cancelUser(Long userManagerId, HttpServletRequest request) {
        try {
            ...
            if (model == null || model.getBeDeleted() == 1) {
                ...
                deleteUserRedis(userManagerId);
                return i;
            }
            //如果是负责人
            if (delModel.getBeSupervisor() == 1) {
                //且此货源站点下无其他员工，则可以直接删除此用户，并同步删除货源站点
                if (userManagerMapper.getStoreUsersCount(delModel.getStoreId()) == 1) {
                    int i = userManagerMapper.cancelUser(userManagerId);
                    storeService.removeById(delModel.getStoreId());
                    deleteUserRedis(userManagerId);
                    return i;
                }
                return -1;
...
//            }
        ...
        if (sysParameterBean == null) {
            ...
            try {
                ...
                if (status != 0) {
                    ...
                    return new ResultInfo<Object>(0, "0", "初始化密码成功", sysParameterBean.getValue());
                } else {
     ...
     * @see com.rofour.baseball.service.user.idl.managecenter.service.UserManagerService#findById(long)
     */
    @Override
     ...
     * @see com.rofour.baseball.service.user.idl.managecenter.service.UserManagerService#findByActiveUsers()
     */
    @Override
     ...
     * @see com.rofour.baseball.service.user.idl.managecenter.service.UserManagerService#searchAll()
     */
    @Override
     ...
     * @see com.rofour.baseball.service.user.idl.managecenter.service.UserManagerService#deleteById(long, HttpServletRequest)
     */
    @Override
     ...
     * @return
     * @see com.rofour.baseball.service.user.UserManagerService#getTenUsers()
     */
    @Override
     ...
     * @return
     * @Description:
     * @see com.rofour.baseball.service.user.UserManagerService#getTodayNewOrderTotal()
     */
    @Override
