 ...
 * @Description: 管理用户传输实体
 * @author wny
 * @date 2016年4月10日 下午9:52:16
 *
 */

public class UserManagerLoginInfo implements Serializable {

	private static final long serialVersionUID = 2676995377814476027L;

	public UserManagerLoginInfo() {

	}

	public UserManagerLoginInfo(Long userManagerId, String loginName, String password, String userName, String userCode,
	...
	public Long getTokenOutTime() {
		return tokenOutTime;
	}

	public void setTokenOutTime(Long tokenOutTime) {
