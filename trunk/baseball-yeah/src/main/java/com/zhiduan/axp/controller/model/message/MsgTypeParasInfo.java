...
/**
 * @ClassName: MsgTypeParasInfo
 * @Description: 消息类型属性业务实体
 * @author: xulang
 * @Date: 2016-09-02 10:48
 */
public class MsgTypeParasInfo {
    /**
     * 主键
     */
    ...
    public MsgTypeParasInfo(Long parasId, String parasCode, String parasName, Integer msgType, Date insertTime, Byte state, Byte beNull, String msgTypeName) {
