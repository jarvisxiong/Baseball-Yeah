...
/**
 * @ClassName: RandomCodeForUserInfo
 * @Description: 用户随机码service层bean
 * @author 周琦
 * @date 2016年3月26日 下午3:23:07
 *
 */

public class RandomCodeInfo implements Serializable {

	private static final long serialVersionUID = -910770744965418993L;
	/**
	 * 编码
	 */
	...
	public RandomCodeInfo(Long randomCodeId, Long userId, String userName, String codeType, String code,
