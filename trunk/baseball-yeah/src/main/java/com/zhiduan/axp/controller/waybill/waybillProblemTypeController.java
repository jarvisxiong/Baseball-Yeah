...
* @Package com.zhiduan.axp.controller.waybill
...
public class waybillProblemTypeController {
	...
	public ResultInfo<String> insert(HttpServletRequest request)
	{
		try {
			...
			return waybillProblemTypeService.insertWaybillProblemType(info)>0?
            new ResultInfo<String>(0, "", "添加成功", ""):new ResultInfo<String>(-1, "", "添加失败", "");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ResultInfo<String> update(HttpServletRequest request)
	{
		try {
			...
			return waybillProblemTypeService.updateWaybillProblemType(info)>0?
            new ResultInfo<String>(0, "", "修改成功", ""):new ResultInfo<String>(-1, "", "修改失败", "");
		} catch (Exception e) {
			return new ResultInfo<String>(-1, "", "服务器异常", "");
		}
	}
	...
	public ResultInfo<String> delete(HttpServletRequest request)
	{
		try {
			...
			return waybillProblemTypeService.deleteWaybillProblemType(data.toString())>0?
            new ResultInfo<String>(0, "", "删除成功", ""):new ResultInfo<String>(-1, "", "删除失败", "");
		} catch (Exception e) {
			return new ResultInfo<String>(-1, "", "服务器异常", "");
		}
	}
