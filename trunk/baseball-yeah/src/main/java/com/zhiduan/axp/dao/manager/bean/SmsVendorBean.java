...
/**
 * @ClassName: TbSmsVendorBean
 * @Description: 短信供应商实体类
 * @author xl
 * @date 2016年3月28日 上午9:43:16
 *
 */

public class SmsVendorBean implements Serializable {

	private static final long serialVersionUID = -8405633563946175813L;
	...
	public SmsVendorBean(String smsVendorId, String smsVendorCode, String smsVendorName, String loginName,
