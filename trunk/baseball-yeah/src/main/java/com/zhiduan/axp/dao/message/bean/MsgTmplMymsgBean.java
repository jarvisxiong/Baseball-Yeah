...
public class MsgTmplMymsgBean {
    ...
    public MsgTmplMymsgBean(Integer id, Integer tmplCode, String tmplName, String tmplContent, String placeSign, Date createTime, Date updateTime, Byte state, Integer msgType, String extendContent, String msgTypeName) {
        this.id = id;
