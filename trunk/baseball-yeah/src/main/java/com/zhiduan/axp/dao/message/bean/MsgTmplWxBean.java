...
public class MsgTmplWxBean {
    ...
    public MsgTmplWxBean(Integer id, Integer tmplCode, String tmplName, String tmplContent, String placeSign, Date createTime, Date updateTime, Byte state, Integer msgType, String wxDetailUrl, String wxTmplId, String msgTypeName) {
        this.id = id;
