package com.zhiduan.axp.service.activity.impl;
...
import com.zhiduan.axp.dao.activity.bean.*;
import com.zhiduan.axp.dao.activity.mapper.*;
import com.zhiduan.axp.dao.manager.bean.CollegeBean;
import com.zhiduan.axp.service.activity.ActivityService;
...
//                        }
            ...
            if (policyBean.getReceives() == null || policyBean.getDeliverys().size() == 0) {
