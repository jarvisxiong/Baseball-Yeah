	...
	$(function() {
		...
		$.get("/manage/menu/menuZtree", function(data, status) {
			$(document).ready(function() {
				$.fn.zTree.init($("#addTreeDemo"), setting, data);
		...
		function count() {
			...
			var zTree = $.fn.zTree.getZTreeObj("addTreeDemo"), checkCount = zTree
		...
		function showNodes() {
			var zTree = $.fn.zTree.getZTreeObj("addTreeDemo"), nodes = zTree
