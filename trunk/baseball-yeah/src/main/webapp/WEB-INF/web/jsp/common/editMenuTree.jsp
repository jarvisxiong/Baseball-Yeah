	...
	$(function() {
		...
		$.get("/manage/menu/menuZtree", function(data, status) {
			$(document).ready(function() {
				$.fn.zTree.init($("#editTreeDemo"), setting, data);
		...
		function count() {
			...
			var zTree = $.fn.zTree.getZTreeObj("editTreeDemo"), checkCount = zTree
		...
		function showNodes() {
			var zTree = $.fn.zTree.getZTreeObj("editTreeDemo"), nodes = zTree
