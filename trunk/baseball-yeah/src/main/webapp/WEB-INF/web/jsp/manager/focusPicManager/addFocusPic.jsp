...
<from id="addForm" method="post" class="form-horizontal"
      action="">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation ">
                            <input type="text" class="form-control" name="adTitle" maxlength="40"
                                   id="add_adTitle" placeholder="标题"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation">跳转url</label>
                        <div class="col-lg-7 div-operation ">
                            <input type="text" class="form-control" name="add_url" maxlength="40"
                                   id="add_url" placeholder="跳转url"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation">广告类型</label>
                        <div class="col-lg-7 div-operation ">
                            <select id="add_adType" class="form-control"name="add_adType" placeholder="广告类型">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation ">
                            <select id="add_userType" class="form-control"name="add_userType" placeholder="用户类型">
                                <option value="">全部</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation ">
                            <div id="myId" class="mydivdrop" action="/manage/focuspic/uploadFile" ></div>
                        </div>
                    </div>
                </div>
