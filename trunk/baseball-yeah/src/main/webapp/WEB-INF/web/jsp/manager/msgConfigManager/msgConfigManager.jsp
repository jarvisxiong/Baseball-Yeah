...
<input type="hidden" class="inmodule" value="msgConfigManagerModules">
							...
							<div class="panel-heading">
								<h4 class="panel-title">
									<a class="a-clear-search" id="clearSearch"> <span
										...
										data-parent="#accordion" href="#msgConfigManagercollapseOne"> 查询条件 </a>
								</h4>
							</div>
							<div id="msgConfigManagercollapseOne" class="panel-collapse collapse in">
								<div class="panel-body">

									<div class="row">
										<div class="form-group col-xs-6">
											<label for="search_messageTypeId"
												class="control-label col-xs-2">消息类型:</label>
											<div class="col-xs-10">
												<select id='search_messageTypeId'
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="col-lg-3 control-label label-operation"
							for="add_messageTypeId">消息类型</label>
					...
					<div class="form-group">
						...
						<div class="radio">
							<input type="radio" name="add_beImmediateSend"
								id="add_beImmediateSend" value="option1" checked="checked">
							<label for="add_beImmediateSend">是</label> <input type="radio"
								name="add_beImmediateSend" id="add_beImmediateSend_no"
								value="option2"> <label for="add_beImmediateSend_no">
								否</label>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-3 control-label label-operation"
							for="add_maxLength">最大长度</label>
						<div class="col-lg-7 div-operation ">
					...
					<div class="form-group">
						...
						<div class="radio">
							<input type="radio" name="add_beEnabled" id="add_beEnabled"
								value="option1" checked="checked"> <label
								for="add_beEnabled">是</label> <input type="radio"
								name="add_beEnabled" id="add_beEnabled_no" value="option2">
							<label for="add_beEnabled_no"> 否</label>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-3 control-label label-operation"
							for="add_sendRoleId">发送角色ID</label>
						<div class="col-lg-7 div-operation ">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="col-lg-3 control-label label-operation"
							for="edit_messageTypeId">消息类型</label>
						<div class="col-lg-7 div-operation ">
					...
					<div class="form-group">
						<label class="col-lg-3 control-label label-operation"
							for="edit_sendTypeId">发送类型</label>
						<div class="col-lg-7 div-operation ">
					...
					<div class="form-group">
						<label class="col-lg-3 control-label label-operation">是否及时发送</label>
						<div class="radio">
							<input type="radio" name="edit_beImmediateSend"
								id="edit_beImmediateSend" value="option1" checked="checked">
							<label for="edit_beImmediateSend">是</label> <input type="radio"
								name="edit_beImmediateSend" id="edit_beImmediateSend_no"
								value="option2"> <label for="edit_beImmediateSend_no">
								否</label>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-3 control-label label-operation"
							for="edit_maxLength">最大长度</label>
						<div class="col-lg-7 div-operation ">
					...
					<div class="form-group">
						<label class="col-lg-3 control-label label-operation">是否启用</label>
						<div class="radio">
							<input type="radio" name="edit_beEnabled" id="edit_beEnabled"
								value="option1" checked="checked"> <label
								for="edit_beEnabled">是</label> <input type="radio"
								name="edit_beEnabled" id="edit_beEnabled_no" value="option2">
							<label for="edit_beEnabled_no"> 否</label>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-3 control-label label-operation"
							for="edit_sendRoleId">发送角色ID</label>
						<div class="col-lg-7 div-operation ">
