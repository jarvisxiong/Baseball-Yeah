...
<script type="text/javascript">
	$(function() {
		$(function() {
			require([ 'peoplePowerManagerModules' ], function(store) {
				store.init();
			});
		});
	});
												...
												<form id="formSearch" class="form-horizontal">
													<div class="row">
														...
														<div class="form-group  col-xs-6">
															...
															<div class="col-xs-10">
																<select id="roleType" class="js-example-data-array form-control"
																	style="width: 240px">
													...
													<div class="row">
														<div class="form-group  col-xs-6">
															<label for="beSysPrivilege"
																class="control-label col-xs-2">是否系统权限</label>
															<div class="col-xs-10">
																<select id='beSysPrivilege'
																	class="js-example-data-array select2-selection__rendered form-control"
																	style="width: 240px">
																	<option value="">请选择</option>
