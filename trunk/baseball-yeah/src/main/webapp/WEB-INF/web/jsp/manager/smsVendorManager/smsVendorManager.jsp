...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            $(function () {
                require(['smsVendorManagerModules'], function (vendor) {
                    vendor.init();
                });
            });
        });
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="add_smsVendorId">服务商ID</label>
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="add_smsVendorCode">服务商编号</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="add_smsVendorName">服务商名称</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="add_loginName">账号</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="add_password">密码</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation ">
                            <select id="add_level" class="form-control"
                                    style="width: 100%" name="add_level">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="add_weight">权重</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="add_threshold">阀值</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="add_channelCode">通道号</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="add_interfaceAddress">接口地址</label>
                        <div class="col-lg-7 div-operation ">
                            <input type="text" name="add_interfaceAddress" class="form-control"
                                   id="add_interfaceAddress" placeholder="接口地址"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation">是否启用</label>
                        <div class="radio">
                            <input type="radio" name="add_status" id="add_status" value="option1"
                                   checked="checked"> <label for="add_status">是</label> <input
                                type="radio" name="add_status" id="add_status_no" value="option2">
                            <label for="add_status_no"> 否</label>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="edit_smsVendorCode">服务商编号</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="edit_smsVendorName">服务商名称</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="edit_loginName">账号</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="edit_password">密码</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation ">
                            <select id="edit_level" class="form-control"
                                    style="width: 100%" name="edit_level">
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                            </select>
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="edit_weight">权重</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="edit_threshold">阀值</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="edit_channelCode">通道号</label>
                        <div class="col-lg-7 div-operation ">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation" for="edit_interfaceAddress">接口地址</label>
                        <div class="col-lg-7 div-operation ">
                            <input type="text" name="edit_interfaceAddress" class="form-control"
                                   id="edit_interfaceAddress" placeholder="接口地址"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label label-operation">是否启用</label>
                        <div class="radio">
                            <input type="radio" name="edit_status" id="edit_status" value="option1"
                                   checked="checked"> <label for="edit_status">是</label> <input
                                type="radio" name="edit_status" id="edit_status_no" value="option2">
