...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            require(['msgTmplSmsManagerModules'], function (quota) {
                quota.init();
            });
        });
    </script>
                                ...
                                <div class="table-responsive">
                                    <div class="panel-body" style="padding-bottom: 0px;">
                                        <div id="toolbar" class="btn-group">
                                            <shiro:hasPermission name="176_ADD">
                                                <button id="btn_add" type="button" class="btn btn-default">
                                                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
                                                </button>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="176_EDIT">
                                                <button id="btn_edit" type="button" class="btn btn-default">
                                                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>修改
                                                </button>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="176_DELETE">
                                                <button id="btn_delete" type="button" class="btn btn-default">
                                                    <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>删除
                                                </button>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="176_QUERY">
                                    ...
                                    <table id="msgTmplSmsTable" class="table">
                                    </table>
                                </div>
                            </div>
                        </div>
...
<jsp:include page="addMsgTmplSms.jsp"></jsp:include>
<jsp:include page="editMsgTmplSms.jsp"></jsp:include>
</body>
</html>
