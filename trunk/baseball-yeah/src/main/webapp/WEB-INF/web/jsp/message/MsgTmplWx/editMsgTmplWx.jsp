        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 control-label">微信详情URL</label>
                        <div class="col-xs-8 div-operation ">
                            <input type="text" class="form-control" name="edit_wxDetailUrl" id="edit_wxDetailUrl"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-xs-3 control-label">微信模板ID</label>
                        <div class="col-xs-8 div-operation ">
                            <input type="text" class="form-control" name="edit_wxTmplId" id="edit_wxTmplId"/>
                        </div>
                    </div>
