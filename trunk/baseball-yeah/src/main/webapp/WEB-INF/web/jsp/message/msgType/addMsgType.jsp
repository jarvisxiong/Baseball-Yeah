                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation ">
                            <input type="text" class="form-control" name="add_typeCode" id="add_typeCode"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation ">
                            <input type="text" class="form-control" name="add_typeName" id="add_typeName"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation">
                            <input type="text" class="form-control" name="add_typeTitle" id="add_typeTitle"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation">
                            <input type="text" class="form-control" name="add_headUrl" id="add_headUrl"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation">
                            <select class="form-control" style="width: 100%" id="add_selRole">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7 div-operation">
                            <select class="form-control" style="width: 100%" id="add_selParentType" name="add_selParentType">
                            </select>
                        </div>
                    </div>
                </div>
