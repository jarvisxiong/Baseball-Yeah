...
<head>
    ...
    <script type="text/javascript">
        $(function() {
            require([ 'msgTypeManagerModules' ], function(quota) {
                quota.init();
            });
        });
    </script>
                                ...
                                <div class="table-responsive">
                                    <div class="panel-body" style="padding-bottom: 0px;">
                                        <div id="toolbar" class="btn-group">
                                            <shiro:hasPermission name="174_ADD">
                                                <button id="btn_add" type="button" class="btn btn-default">
                                                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
                                                </button>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="174_EDIT">
                                                <button id="btn_edit" type="button" class="btn btn-default">
														<span class="glyphicon glyphicon-pencil"
                                                              aria-hidden="true"></span>修改
                                                </button>
                                            </shiro:hasPermission>
                                            <shiro:hasPermission name="174_DELETE">
                                            ...
                                            <shiro:hasPermission name="174_QUERY">
...
<jsp:include page="addMsgType.jsp"></jsp:include>
<jsp:include page="editMsgType.jsp"></jsp:include>
</body>
</html>
