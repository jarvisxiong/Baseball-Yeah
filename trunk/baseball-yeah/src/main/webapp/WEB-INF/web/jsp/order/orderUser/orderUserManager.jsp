...
<input type="hidden" class="inmodule" value="orderUserManagerModules">
						...
						<div class="table-responsive">
							...
							<div class="panel-body" style="padding-bottom: 0px;">
									...
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="a-clear-search" id="clearSearch"> <span
												...
												href="#orderUsercollapseOne"> 查询条件 </a>
										</h4>
									</div>
									<div id="orderUsercollapseOne" class="panel-collapse collapse in">
								...
								<div id="toolbar" class="btn-group">
									...
									<shiro:hasPermission name="142_QUERY">
...
<jsp:include page="orderUserDetail.jsp"></jsp:include>