    ...
    <div class="main-box-body clearfix">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a class="a-clear-search" id="clearSearch"> <span
                                    ...
                                    href="#commentRateManager-collapseOne"> 查询条件 </a>
                        </h4>
                    </div>
                    <div id="commentRateManager-collapseOne" class="panel-collapse collapse in">
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-6">
                                        ...
                                        <div class="control-label col-xs-10" style="text-align: left;">
                                            <select style="width: 350px" id="campus" multiple>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-xs-6">
        ...
        <div class="row table-responsive">
            <div class="panel-body" style="padding-bottom: 0px;">
                ...
                <table id="commentTable" data-show-export="true">
...
<input type="hidden" class="inmodule" value="commentRateManagerModules">
