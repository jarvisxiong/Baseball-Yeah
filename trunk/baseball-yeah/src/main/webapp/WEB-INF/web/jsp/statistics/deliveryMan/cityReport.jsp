...
<script type="text/javascript">
	$(function() {
		if ('${id}' != null && '${id}' != '') {
			$('#firstProvince',$('#indextab').tabs('getSelected')).val('${id}');
		}
		if ('${time}' != null && '${time}' != '') {
			$('#time',$('#indextab').tabs('getSelected')).val('${time}');
		}
		if ('${cityflag}' != null && '${cityflag}' != '') {
			$('#cityflag',$('#indextab').tabs('getSelected')).val('${cityflag}');
		}
	});
</script>
<input type="hidden" class="inmodule" value="cityReportModules" />
				...
				<div class="col-lg-12">
					<div class="main-box clearfix">
								...
								<div id="collapseThree" class="panel-collapse collapse in">
									...
									<!-- 查询条件第一行 -->
											<div class="row"> 											
												...
												<input type="hidden" value="" id="firstProvince"/>
												<input type="hidden" value="" id="time"/>
												<input type="hidden" value="" id="cityflag"/>
											</div>                                          
									</div>
								</div>
							</div>
						...
						<div class="main-box-body clearfix">
							<div class="row">
								<table id="cityReportTable" class="table">
