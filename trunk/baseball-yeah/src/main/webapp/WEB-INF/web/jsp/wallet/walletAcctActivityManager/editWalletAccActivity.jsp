                                    ...
                                    <div id="mainActivity">
                                        ...
                                        <div class="form-group col-lg-12 group-activity">
                                            ...
                                            <div class="col-lg-7 div-operation ">
                                                <textarea type="text" class="form-control" id="remark" placeholder="备注" data-bind='value: remark'></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-12 group-activity">
                                        ...
                                        <div class="form-group col-lg-12 group-activity">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                <button id="btn_add" type="button" data-bind='click: addContact' class="btn btn-default">
                                                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增策略
                                                </button>
                                                <button type="button" id="btnUpdate" data-bind="click: update" class="btn btn-default">
                                ...
                                <div class="col-lg-12">
                                    <div class="main-box clearfix">
                                        <header class="main-box-header clearfix">
                                            <input type="hidden" data-bind='value: policyId'>
                                        </header>
                                                    ...
                                                    <div class="tab-pane fade active in" data-bind="attr: { id: 'tab-home' +  $index()}">
                                                        <div class="editActivityEnable">
                                                            ...
                                                            <div class="form-group col-lg-12 group-activity">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control" data-bind='value: policyPriority'
                                                                           id="policyPriority"
                                                            ...
                                                            <div data-bind="foreach: deliverys">
                                                                <div class="row">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <input type="text" data-bind='value: scale' class="form-control scale"
                                                                                   placeholder="比例">
                                                                        </div>
                                                        ...
                                                        <div data-bind="foreach: receives">
                                                            <div class="row">
                                                                <div class="form-group col-lg-12 group-activity">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <input type="hidden" class="operasel" data-bind='value: operator'>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        ...
                                                                        <div class="quotaDivProvinceValue" style="display: none">
                                                                            <select style="width: 100%" class='js-example-data-array '
                                                                        ...
                                                                        <div class="quotaDivCityValue" style="display: none">
                                                                        ...
                                                                        <div class="quotaDivOrderTypeValue" style="display: none">
                                                                            <select style="width: 100%" class='js-example-data-array quotaDivOrderTypeValue'
                                                                                    data-bind='selOrderType : quotaDivOrderTypeValue'
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-lg-12 group-activity ">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        ...
                                                                        <div class="quotaDivCityValue" style="display: none">
                                                                            <input type="hidden" class="inpvalue" data-bind='value: quotaCityField'>
                                                                            <select
                                                                                    style="width: 100%" class='js-example-data-array quotaCityField'
                                                                                    data-bind='selCity : quotaCityField' multiple="multiple"></select></div>
                                                                        <div class="quotaDivTimeValue" style="display: none">
