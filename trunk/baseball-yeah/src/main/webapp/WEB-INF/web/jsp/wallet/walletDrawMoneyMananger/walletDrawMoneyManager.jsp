...
<input type="hidden" class="inmodule" value="walletDrawMoneyManager">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        ...
                                        <a class="accordion-toggle a-search" data-toggle="collapse"
                                           data-parent="#accordion" href="#walletDrawMoneyManangercollapseOne"> 查询条件 </a>
                                    </h4>
                                </div>
                                <div id="walletDrawMoneyManangercollapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        <form id="formSearch" class="form-horizontal" role="form">
                                            <div class="row">
                                                <div class="form-group col-xs-6">
                                                    <label class="control-label col-xs-2"
                                                           for="transationid">账号类型</label>
                                                    <div class="col-xs-10">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-xs-6">
                                                    <div class="input-daterange">
                                                        <label class="control-label col-xs-2" for="apply_start_date">提现日期</label>
                                                        <div class="col-xs-4">
                                                ...
                                                <div class="form-group col-xs-6">
                                                    <div class="input-daterange">
                                                        <label class="control-label col-xs-2" for="check_start_date">审核时间</label>
                                                        <div class="col-xs-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-xs-6">
                                                    <div class="input-daterange">
                                                        <label class="control-label col-xs-2" for="arrive_start_date">到账时间</label>
                                                        <div class="col-xs-4">
                                                            <div class="input-group date" id="arrivestarttimePicker">
                                                                <input type="text" class="form-control"
                                                                       id="arrive_start_date"/>
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon-calendar glyphicon"></span>
                                                                </span>
                                                            </div>
                        ...
                        <div class="row">
                            <div id="toolbar" class="btn-group">
                                ...
                                <shiro:hasPermission name="136_AUDIT">
                                    ...
                                    <button id="btnAuditFail" type="button" class="btn btn-default">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" type="text" id="thdId" name="thdId" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <div class="radio" style="float: left;">
                                    ...
                                    <label for="isApprove">通过</label>
                                    <input type="radio" name="drawState" id="isRefuse" value="1">
                                    <label for="isRefuse">驳回</label>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#applystarttimePicker').datetimepicker({
            ...
            $('#applyendtimePicker').datetimepicker('setStartDate', startTime);
            $('#checkstarttimePicker').datetimepicker('setStartDate', startTime);
            $('#arrivestarttimePicker').datetimepicker('setStartDate', startTime);
        });
        ...
        $('#arrivestarttimePicker').datetimepicker({
            ...
            var startTime = e.date;
            $('#arriveendtimePicker').datetimepicker('setStartDate', startTime);
        });
