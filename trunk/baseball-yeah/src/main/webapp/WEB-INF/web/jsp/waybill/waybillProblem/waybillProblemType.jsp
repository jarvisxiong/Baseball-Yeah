...
<script type="text/javascript">
	$(function() {
		...
		require([ 'waybillProblemTypeModules' ], function(
				waybillProblemTypeTable) {
			waybillProblemTypeTable.init();
		});
	});
</script>
<style type="text/css">
										...
										<form id="formSearch" class="form-horizontal" role="form">
											<div class="row">
												<div class="form-group col-xs-6">
													...
													<div class="col-xs-10">
														<select class="form-control" id="sel_group_search" style="width: 240px;"
															name="sel_group_search">
												...
												<div class="form-group col-xs-6">
													<div class="input-daterange">
														<label class="control-label col-xs-2" for="startDate">更新时间:</label>
														<div class="col-xs-4">
				...
				<div class="modal-body">
					<form id="addForm" method="post" action="">
						<div class="form-group">
							<label>异常类型编码</label> <input type="text" class="form-control"
								name="add_problemTypeCode" maxlength="40"
								id="add_problemTypeCode" placeholder="异常类型编码" />

						</div>

						<div class="form-group">
							<label>异常类型名称</label> <input type="text"
								name="add_problemTypeName" class="form-control" maxlength="40"
						...
						<div class="form-group">
							<label>所属类别</label> <select class="form-control" id="sel_group"
								name="group">
								<option value="1">货源</option>
								<option value="2">门店</option>
								<option value="3">众包</option>
						...
						<div class="form-group">
							...
							<div class="radio">
								<input type="radio" name="doUplaodfile" id="doUplaodfile1"
									value="1" checked> <label for="doUplaodfile1">是</label>
								<input type="radio" name="doUplaodfile" id="doUplaodfile2"
									value="0"><label for="doUplaodfile2"> 否</label>
							</div>
						</div>
						<div class="form-group">
							<label>是否启用</label>
							<div class="radio">
								<input type="radio" name="enabled" id="enabled1" value="1"
									checked> <label for="enabled">是</label> <input
									type="radio" name="enabled" id="enabled2" value="0"><label
									for="enabled2"> 否</label>
							</div>
						</div>
						<div class="form-group">
							<label>是否必须做退件</label>
							<div class="radio">
								<input type="radio" name="doReturn" id="doReturn1" value="1"
									checked> <label for="doReturn1">是</label> <input
									type="radio" name="doReturn" id="doReturn2" value="0"><label
									for="doReturn2"> 否</label>
							</div>
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="editForm" method="post" action="">
						<div class="form-group">
							<label>异常类型编码</label> <input type="text" readonly="readonly"
								class="form-control" name="update_problemTypeCode"
						...
						<div class="form-group">
							<label>异常类型名称</label> <input type="text"
								name="update_problemTypeName" class="form-control"
								maxlength="40" id="update_problemTypeName" placeholder="异常类型名称">

						</div>
						<div class="form-group">
							<label>序号</label> <input type="text" class="form-control"
								name="update_sortNo" maxlength="40" id="update_sortNo"
								placeholder="序号" />

						</div>
						<div class="form-group">
							<label>所属类别</label> <select class="form-control"
								id="update_sel_group" name="group">
								<option value="1">货源</option>
								<option value="2">门店</option>
								<option value="3">众包</option>
								<option value="4">收件人</option>
						...
						<div class="form-group">
							<label>是否需要上传附件</label>
							<div class="radio">
								<input type="radio" name="update_doUplaodfile"
									id="update_doUplaodfile1" value="1" checked> <label
									for="update_doUplaodfile1">是</label> <input type="radio"
									name="update_doUplaodfile" id="update_doUplaodfile2" value="0"><label
									for="update_doUplaodfile2"> 否</label>
							</div>
						</div>
						<div class="form-group">
							<label>是否启用</label>
							<div class="radio">
								<input type="radio" name="update_enabled" id="update_enabled1"
									value="1" checked> <label for="update_enabled">是</label>
								<input type="radio" name="update_enabled" id="update_enabled2"
									value="0"><label for="update_enabled2"> 否</label>
							</div>
						</div>
						<div class="form-group">
							<label>是否必须做退件</label>
							<div class="radio">
								<input type="radio" name="update_doReturn" id="update_doReturn1"
									value="1" checked> <label for="update_doReturn1">是</label>
								<input type="radio" name="update_doReturn" id="update_doReturn2"
									value="0"><label for="update_doReturn2"> 否</label>
							</div>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default"
