    ...
    return {
        init: function (args) {
            ...
            $("#btn_query").click(function () {
                $("#msgTmplMymsgTable").bootstrapTable('refresh');
            });
        ...
        edit: function () {
            var self = this;
            var arrselections = $("#msgTmplMymsgTable").bootstrapTable('getSelections');
            ...
            $("#edit_extendContent").val(arrselections[0].extendContent);
